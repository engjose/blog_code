...
---
### 数据库设计
#### <font color='blue'>数据表结构</font>
![enter image description here](http://oayt7zau6.bkt.clouddn.com/sql_struct.jpg)
#### <font color='blue'>建表语句</font>
1.user表
```sql
